...
parser.add_argument('--dumpt', type=float, default=6, help='Dump time in hours. Default 24.')
...
thours = int(args.tmax)
chkfile = DumbCheckpoint(name+"_"+str(thours)+"h", mode=FILE_READ)
chkfile.load(un, name="Velocity")
chkfile.load(etan, name="Elevation")
t = chkfile.read_attribute("/", "time")
tdump = chkfile.read_attribute("/", "tdump")
tcheck = chkfile.read_attribute("/", "tcheck")
chkfile.close()
print("Picked up at t = ", t, ", tdump = ", tdump, ", tcheck = ", tcheck)
